  ...
  return (
    <div className="h-screen w-screen md:w-[400px] bg-white shadow-lg p-5 z-20 overflow-auto">
      ...
      <div>
        ...
        {place && place.photos && place.photos[0]?.photo_reference ? (
          <Image
        ...
        <div className="mt-5 flex gap-5">
          <button
            ...
            className="flex gap-2 p-1 px-3 bg-purple-500 rounded-full text-white hover:scale-105 transition-all"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
