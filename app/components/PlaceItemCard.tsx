...
const PlaceItemCard: React.FC<PlaceItemCardProps> = ({ place }) => {
  return (
    <div className=' translate-y-[100px] w-full z-10 border-[1px] rounded-xl shadow-md hover:scale-105 transition-all cursor-pointer'>
